    ...
    <div id="authorBooks" className="dark:text-gray-100/80">
      ...
      >
        ...
        {props.scrapeURL && (
          ...
          >
            <p className="flex snap-center shrink-0 first:-ml-12 max-w-xs xl:max-w-sm p-2 sm:py-6 px-2 hover:py-6 bg-white/40 dark:bg-slate-800 rounded-2xl  hover:ring hover:ring-rose-600 hover:bg-rose-300 dark:hover:bg-rose-900 transition duration-300 delay-40 hover:delay-40">
